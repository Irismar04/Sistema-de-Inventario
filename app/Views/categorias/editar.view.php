    ...
    <div class="container-fluid px-4">
        <ol class="breadcrumb mb-4">
            ...
            <div class="col-sm-5 col-md-10 col-lg-10 col-xl-10 py-10 bg-white">
                <h2 class="text-center font-weight-light my-4">Formulario de Editar Categoria</h2>
                <form method="post" action="http://localhost/sistema-de-inventario/public/categorias/actualizar">
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre de la categoria</label>

                        <input type="text" class="form-control" value="<?= $categoria['nom_categoria'] ?>" name="nombre" id="nombre" placeholder="Nombre de la categoria" autofocus />
