                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="http://localhost/sistema-de-inventario/public/anadir">Consultar Productos</a>
                                    ...
                                    <a class="nav-link" href="http://localhost/sistema-de-inventario/public/lista">Consultar Categoria</a>
                                    <a class="nav-link" href="http://localhost/sistema-de-inventario/public/lista">Consultar Marca</a>
                                </nav>
                            </div>
